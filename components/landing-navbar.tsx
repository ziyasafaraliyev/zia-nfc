...
function LangSwitcher() {
  ...
  return (
    <div
      ...
      className="flex shrink-0 items-center overflow-hidden rounded-full border border-slate-200 bg-slate-100 text-xs font-black uppercase tracking-[0.12em] shadow-sm"
    >
      <button
        type="button"
        aria-pressed={lang === "az"}
        onClick={() => setLang("az")}
        className={`px-3 py-1.5 transition-all duration-200 ease-out ${
          lang === "az"
