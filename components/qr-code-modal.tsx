  ...
  return (
    <>
      <div
        ...
        className="lux-qr-card lux-card-enter-7 group flex cursor-pointer items-center gap-5 rounded-2xl p-4 transition duration-200 hover:scale-[1.02] active:scale-[0.98]"
      >
