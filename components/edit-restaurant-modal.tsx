...
interface EditRestaurantModalProps {
  ...
  onClose: () => void;
  restaurant: any;
  onSave: (updatedRestaurant: any) => void;
}

export default function EditRestaurantModal({ isOpen, onClose, restaurant, onSave }: EditRestaurantModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-[2rem] w-full max-w-md shadow-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white">
          <h3 className="text-xl font-black tracking-tight text-slate-900">Restoranı Redaktə Et</h3>
          <button
            onClick={onClose}
